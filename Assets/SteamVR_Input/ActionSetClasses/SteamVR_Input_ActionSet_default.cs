...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 Joystick_Touchpad
        {
            get
            {
                return SteamVR_Actions.default_Joystick_Touchpad;
            }
        }
        
        public virtual SteamVR_Action_Boolean DropRight
        {
            get
            {
                return SteamVR_Actions.default_DropRight;
            }
        }
        
        public virtual SteamVR_Action_Boolean DropLeft
        {
            get
            {
                return SteamVR_Actions.default_DropLeft;
            }
        }
