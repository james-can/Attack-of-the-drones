...
namespace Valve.VR.InteractionSystem
{
    public class ModalThrowable : Throwable
    {
        ...
        protected override void HandAttachedUpdate(Hand hand)
        {
            ...
            bool hasPinchPose = interactable.skeletonPoser.blendingBehaviours.Count != 0 
                && interactable.skeletonPoser.blendingBehaviours.Find(b => b.name == "PinchPose") != null;
            if (interactable.skeletonPoser != null && hasPinchPose)
            {
